...
namespace SchemaCreator.Designer.AttachedProperties
{
    public static class DrawAttachedProperty
    {
        ...
        {
            if (_drawableInstance == null || _selectedItemType != SelectedItemType.DrawItem) return;
            ...
            if (_selectionStartPoint.HasValue)
            {
                ...
                {
                    var adorner = new DrawAdorner(_itemsPanel, _selectionStartPoint, _designerViewModel, _drawableInstance);
